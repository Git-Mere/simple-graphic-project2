...
public:
    ...
    [[nodiscard]] bool LoadFromMemory(int image_width, int image_height, const RGBA* colors, ColorFormat format = RGBA8) noexcept;

    void UseForSlot(unsigned texture_unit) const noexcept;
