...
namespace demos
{
    D01HelloQuad::D01HelloQuad()
    {
        ...
        const std::array vertices = {
            Vertex{float3{ -0.75, 0.75f, 0 }, color3{ 0, 1, 1 }, texture2{ 0.0f, 1.0f }}, // top left
            Vertex{float3{ -0.75, -0.75, 0 }, color3{ 1, 0, 1 }, texture2{ 0.0f, 0.0f }}, // bottom left
            Vertex{ float3{ 0.75, -0.75, 0 }, color3{ 1, 1, 0 }, texture2{ 1.0f, 0.0f }}, // bottom right
            Vertex{  float3{ 0.75, 0.75, 0 }, color3{ 1, 0, 0 }, texture2{ 1.0f, 1.0f }}, // top right
        };
    ...
    void D01HelloQuad::Draw() const
    {
        ...
        shader.SendUniform("u_resolution", window);
        shader.SendUniform("u_time", static_cast<float>(environment::ElapsedTime));
        quadMesh.Use();
