...
namespace
{
    ...
    namespace asset_paths
    {
        ...
        constexpr auto duck_image_path = "D08ComputeShaders/duck.png";
...
namespace demos
{
    D08ComputeShaders::D08ComputeShaders()
    {
        ...
        assetReloader.SetAndAutoReloadTexture(duckTexture, asset_paths::duck_image_path);
    ...
    void D08ComputeShaders::Draw() const
    {
        ...
        GL::BindImageTexture(1, bellTexture.GetHandle(), 0, GL_FALSE, 0, GL_READ_ONLY, GL_RGBA8);
        GL::BindImageTexture(2, duckTexture.GetHandle(), 0, GL_FALSE, 0, GL_READ_ONLY, GL_RGBA8);
    ...
    {
        GL::GetProgramiv(computeShaders[selectedComputeShader].GetHandle(), GL_COMPUTE_WORK_GROUP_SIZE, &localWorkgroupSize[0]);
